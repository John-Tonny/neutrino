...
type ChainSource interface {
	...
	GetBlock(chainhash.Hash, ...QueryOption) (*vclutil.Block, error)
...
func WatchAddrs(watchAddrs ...vclutil.Address) RescanOption {
	return func(ro *rescanOptions) {
...
func extractBlockMatches(chain ChainSource, ro *rescanOptions,
	curStamp *headerfs.BlockStamp) ([]*vclutil.Tx, error) {
	...
	relevantTxs := make([]*vclutil.Tx, 0, len(block.Transactions()))
...
func (ro *rescanOptions) spendsWatchedInput(tx *vclutil.Tx) bool {
...
func (ro *rescanOptions) paysWatchedAddr(tx *vclutil.Tx) (bool, error) {
...
func AddAddrs(addrs ...vclutil.Address) UpdateOption {
